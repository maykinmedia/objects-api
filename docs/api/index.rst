...
`Objecttypes API`_      1.1.1 (
                        `Redoc <https://raw.githubusercontent.com/maykinmedia/objecttypes-api/1.1.1/src/objecttypes/api/v1/openapi.yaml>`__,
                        `Swagger <https://raw.githubusercontent.com/maykinmedia/objecttypes-api/1.1.1/src/objecttypes/api/v1/openapi.yaml>`__
                        )
`Objects API`_          2.0.0 (
                        ...
                        `Swagger <https://petstore.swagger.io/?url=https://raw.githubusercontent.com/maykinmedia/objects-api/2.0.0/src/objects/api/v2/openapi.yaml>`__
                        )
======================  ==========================================

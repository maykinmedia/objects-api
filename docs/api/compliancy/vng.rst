...
.. csv-table:: 5. Compliancy en testen
   ...
   1;API-standaard is geïmplementeerd in een referentieimplementatie indien voor de standaard meerdere providers van toepassing kunnen zijn;Yes (`1 <https://github.com/maykinmedia/open-object/>`__, `2 <https://github.com/maykinmedia/objecttypes-api/>`__);
   2;Testgevallen zijn beschreven voor elke service/operatie en aanvullende specificaties, zowel voor de happy als de unhappy flows;Yes (`1 <https://github.com/maykinmedia/open-object/actions>`__, `2 <https://github.com/maykinmedia/objecttypes-api/actions>`__);
...
.. csv-table:: 6. Referentie-implementatie
   ...
   1;Zowel consumer als provider implementatie. Provider alleen van toepassing als meerdere providers mogelijk zijn. Minimaal zorgen voor test-implementatie;Yes (`1 <https://github.com/maykinmedia/open-object/>`__, `2 <https://github.com/maykinmedia/objecttypes-api/>`__); Same as 5.1.
...
.. csv-table:: 7. Overdrachtsdocument (beheer)
   ...
   1;De genomen ontwerpbeslissingen zijn beschreven en gemotiveerd;`Yes <https://github.com/maykinmedia/open-object/issues>`__;
   2;Er is een lijst met bekende fouten, gewenste verbeteringen, gewenste uitbreidingen (backlog);`Yes <https://github.com/maykinmedia/open-object/issues>`__;

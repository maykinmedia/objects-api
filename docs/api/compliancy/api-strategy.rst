...
.. csv-table:: Adherence to API principles
   ...
   API-04,Define interfaces in Dutch unless there is an official English glossary,"No, Open Object has English interface"
   ...
   API-17,Publish documentation in Dutch unless there is existing documentation in English or there is an official English glossary available,"No, Open Object API has English documentation"
